...
Source0: ftp://ftp.postgresql.org/pub/source/v%{version}%{prereleasetag}/postgresql-%{version}%{prereleasetag}.tar.gz
...
%prep
%setup -q %{?scl:-n %{pkg_name}-%{version}%{prereleasetag}} -a 16
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
